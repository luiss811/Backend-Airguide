...
import { authenticate, requireProfesor, AuthRequest } from '../../middleware/auth.middleware.js';
...
app.get('/eventos', authenticate, requireProfesor, async (req: AuthRequest, res: Response) => {
  try {
...
app.post('/eventos', authenticate, requireProfesor, async (req: AuthRequest, res: Response) => {
  try {
    ...
    const responsePayload = { ...nuevoEvento } as any;
