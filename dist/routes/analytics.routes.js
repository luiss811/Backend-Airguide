...
// Edificios por tipo
router.get('/edificios-tipo', authenticate, requireAdmin, async (req, res) => {
    try {
...
// Eventos próximos
router.get('/eventos-proximos', authenticate, requireAdmin, async (req, res) => {
    try {
        const now = new Date();
...
router.get('/accesos-recientes', authenticate, requireAdmin, async (req, res) => {
    try {
...
// Accesos por día
router.get('/accesos-timeline', authenticate, requireAdmin, async (req, res) => {
    try {
...
// Usuarios por rol
router.get('/usuarios-rol', authenticate, requireAdmin, async (req, res) => {
    try {
...
// Rutas más populares
router.get('/rutas-populares', authenticate, requireAdmin, async (req, res) => {
    try {
